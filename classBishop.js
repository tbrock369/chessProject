class Bishop extends Piece
{
	...
	createPiece()
	{
		...
		document.getElementById(this.pieceId).getContext("2d").lineTo(30, 35);
		document.getElementById(this.pieceId).getContext("2d").lineTo(32, 30);
		document.getElementById(this.pieceId).getContext("2d").lineTo(22, 12);
		...
		document.getElementById(this.pieceId).getContext("2d").lineTo(18, 12);
		document.getElementById(this.pieceId).getContext("2d").lineTo(8, 30);
